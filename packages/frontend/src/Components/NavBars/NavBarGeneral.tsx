  ...
  return (
    <nav className="bg-blue-600 p-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        {/* Logo */}
        <img src="https://via.placeholder.com/40" alt="Logo" className="w-10 h-10 mr-2" />
        <a href="#" className="text-white text-xl font-bold">Velia</a>
        </div>
        {/* Search Input */}
        <div className="hidden md:flex flex-1 justify-center items-center">
          <input
            type="text"
            placeholder="Buscar"
            className="w-1/3 px-4 py-2 rounded-md text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-black-500 focus:ring-opacity-50"
          />
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="text-white relative">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-5-5.917V5a2 2 0 00-4 0v.083A6.002 6.002 0 004 11v3.159c0 .538-.214 1.055-.595 1.436L2 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
            </svg>
      ...
      {showSearch && (
        <div className="mt-2 md:hidden">
          <input
            type="text"
            placeholder="Buscar"
            className="w-full px-4 py-2 rounded-md text-gray-700 bg-white focus:outline-none focus:ring-2 focus:ring-black-500 focus:ring-opacity-50"
          />
        </div>
      )}
    </nav>
